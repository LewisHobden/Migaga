...
extensions = ["cogs.admin", "cogs.games.currency", "cogs.utilities.get_messages", "cogs.games.games", "cogs.customcommands", "cogs.games.fun", "cogs.people", "cogs.starboard", "cogs.serverlogs","cogs.games.quiz"]
