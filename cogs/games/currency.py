...
class Money(commands.Cog):
    ...
    async def money(self, ctx):
        ...
        await self.client.send("**" + ctx.message.author.name + "**, You have earned " + str(
            money['money']) + " " + self.CURRENCY_NAME + " after playing " + str(money['times_played']) + " games!")
    ...
    async def moneyfor(self, ctx, member: discord.Member):
        ...
        await self.client.send("**" + member.name + "**, You have earned " + str(
            money['money']) + " " + self.CURRENCY_NAME + " after playing " + str(money['times_played']) + " games!")
    ...
    async def give(self, ctx, recipient: discord.Member, amount):
        ...
        await self.client.send("Success! I have given **" + recipient.name + "** " + str(
            amount) + " " + self.CURRENCY_NAME + " from **" + giver.name + "**!")
